...
def compile_file(dict):
    ...
    dest = dest[:-4]+"_qr.tex"
    lien_html = "http://xpessoles-cpge.fr/pdf/"+dest[:-6]+"Corrige.pdf"
    print(lien_html)
    ...
    fid.write("\\usepackage{fancyqr} \n")
    fid.write("\\fancyqrset{height=2.5cm,level=H,padding} \n")
    fid.write("\\begin{document} \n")
    fid.write("\\fancyqr{"+lien_html+"} \n")
    ...
    src = dest[:-4]
    dest = "qr/"+src
    print(src+".pdf",dest+".pdf")
    # # On stocke
    shutil.copy(src+".pdf",dest+".pdf")
